...
namespace CDAApp.Client.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<CDAApp.Server.Models.ApplicationUser> users;
        protected RadzenDataGrid<CDAApp.Server.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(CDAApp.Server.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(CDAApp.Server.Models.ApplicationUser user)
        {
            try
            {
